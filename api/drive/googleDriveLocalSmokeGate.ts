...
export const GOOGLE_DRIVE_LOCAL_SMOKE_MODE_ENV_KEY = 'GOOGLE_DRIVE_LOCAL_SMOKE_MODE'
export const GOOGLE_DRIVE_LOCAL_SMOKE_MODE_GOOGLE_ACTUAL = 'google_actual'
